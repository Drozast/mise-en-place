    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div
          ...
          className="bg-dark-800 border border-dark-700 rounded-xl p-6 cursor-pointer transition-all duration-200 hover:scale-105 hover:border-orange-500 hover:shadow-lg hover:shadow-orange-500/20 group"
        >
          <div className="flex items-start justify-between mb-4">
            <div className="text-sm text-dark-400 group-hover:text-orange-400 transition-colors">Total Ventas</div>
            <div className="p-2 bg-dark-700 rounded-lg group-hover:bg-orange-500/10 transition-colors">
              <TrendingUp className="w-5 h-5 text-green-500 group-hover:text-green-400 transition-colors" />
            </div>
          </div>
          <div className="text-4xl font-bold text-white mb-1">{stats.totalVentas}</div>
          <div className="text-xs text-dark-400 group-hover:text-dark-300 transition-colors">Pizzas vendidas hoy</div>
        </div>
        ...
        >
          <div className="flex items-start justify-between mb-4">
            <div className="text-sm text-dark-400 group-hover:text-orange-400 transition-colors">Masas Usadas</div>
            <div className="p-2 bg-dark-700 rounded-lg group-hover:bg-orange-500/10 transition-colors">
        ...
        >
          <div className="flex items-start justify-between mb-4">
            <div className="text-sm text-dark-400 group-hover:text-orange-400 transition-colors">Alertas Activas</div>
            <div className="p-2 bg-dark-700 rounded-lg group-hover:bg-orange-500/10 transition-colors">
              <AlertTriangle className="w-5 h-5 text-yellow-500 group-hover:text-yellow-400 transition-colors" />
            </div>
          </div>
          <div className="text-4xl font-bold text-white mb-1">{stats.alertasActivas}</div>
          <div className="text-xs text-dark-400 group-hover:text-dark-300 transition-colors">
        ...
        >
          <div className="flex items-start justify-between mb-4">
            <div className="text-sm text-dark-400 group-hover:text-orange-400 transition-colors">Estado Inventario</div>
            <div className="p-2 bg-dark-700 rounded-lg group-hover:bg-orange-500/10 transition-colors">
              <Package className="w-5 h-5 text-blue-500 group-hover:text-blue-400 transition-colors" />
            </div>
          </div>
          <div className="text-4xl font-bold text-white mb-1">{stats.ingredientesActivos}</div>
          <div className="text-xs text-dark-400 group-hover:text-dark-300 transition-colors">Ingredientes activos</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-dark-800 border border-dark-700 rounded-xl p-6">
          <h3 className="text-lg font-semibold text-white mb-4">Ventas por Pizza</h3>
          <div className="space-y-3">
            {ventasPorPizza.length > 0 ? (
              ventasPorPizza.map((pizza, idx) => (
                ...
                >
                  <div>
                    <p className="font-medium text-white">{pizza.name}</p>
                    <p className="text-sm text-dark-400 capitalize">{pizza.type}</p>
                  </div>
                  <div className="text-2xl font-bold text-white">{pizza.total_quantity}</div>
                </div>
              ))
            ) : (
        ...
        <div className="bg-dark-800 border border-dark-700 rounded-xl p-6">
          <h3 className="text-lg font-semibold text-white mb-4">Distribución por Tamaño</h3>
          <div className="space-y-4">
            {/* Tamaño L */}
            <div>
              <div className="flex justify-between items-center mb-2">
                <div className="flex items-center gap-2">
                  <span className="text-white font-semibold">Tamaño L</span>
                  <span className="text-sm text-dark-400">
                    {ventasPorTamano.L.disponibles} masas disponibles
                  </span>
                </div>
                <span className="text-white font-bold">{ventasPorTamano.L.count}</span>
              </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                <div className="flex items-center gap-2">
                  <span className="text-white font-semibold">Tamaño M</span>
                  <span className="text-sm text-dark-400">
                    {ventasPorTamano.M.disponibles} masas disponibles
                  </span>
                </div>
                <span className="text-white font-bold">{ventasPorTamano.M.count}</span>
              </div>
              <div className="w-full bg-dark-700 rounded-full h-2 overflow-hidden">
                <div
                  className="bg-orange-500 h-full rounded-full transition-all"
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                <div className="flex items-center gap-2">
                  <span className="text-white font-semibold">Tamaño S</span>
                  <span className="text-sm text-dark-400">
                    {ventasPorTamano.S.disponibles} masas disponibles
                  </span>
                </div>
                <span className="text-white font-bold">{ventasPorTamano.S.count}</span>
              </div>
              <div className="w-full bg-dark-700 rounded-full h-2 overflow-hidden">
                <div
                  className="bg-orange-500 h-full rounded-full transition-all"
