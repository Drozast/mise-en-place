          ...
          <div className="space-y-4">
            {pizzas.map((recipe) => (
              ...
              >
                ...
                <div>
                  <p className="text-sm font-semibold text-dark-300 mb-2">Ingredientes:</p>
                  <ul className="space-y-1">
                    {recipe.ingredients?.map((ing: any) => (
                      <li key={ing.id} className="text-sm text-dark-400">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <div className="flex justify-between items-center mb-3">
              <label className="block text-sm font-medium text-dark-300">Ingredientes</label>
              <button
                type="button"
            ...
            <div className="space-y-2">
              {formData.ingredients.map((ing, index) => (
                <div key={index} className="flex gap-2">
                  <select
                    className="flex-1 bg-white border-2 border-dark-600 rounded-lg px-4 py-3 text-dark-900 focus:outline-none focus:border-orange-500 transition-colors font-medium"
                  ...
                  <input
                    ...
                    className="w-28 bg-white border-2 border-dark-600 rounded-lg px-4 py-3 text-dark-900 placeholder-dark-400 focus:outline-none focus:border-orange-500 transition-colors font-medium"
                    value={ing.quantity}
                    onChange={(e) =>
